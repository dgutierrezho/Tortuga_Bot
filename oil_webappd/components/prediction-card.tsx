  ...
  return (
    <Card className="rounded-2xl shadow-md border-border/60">
      <CardHeader>
        ...
        <CardDescription>
          Run the detection model on your uploaded image
        </CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col gap-6">
        ...
        {!hasFile && !result && !error && !isLoading && (
          <p className="text-center text-sm text-muted-foreground py-6">
            Upload an image first to run the oil spill detection model.
          </p>
        )}
        ...
        {isLoading && (
          <div className="flex flex-col items-center gap-3 py-6">
            ...
            <p className="text-sm text-muted-foreground">
              Processing your image through the detection model...
            </p>
          </div>
        )}
